...
| 2. Core MVP (P0) | ✅ Complete | 100% | Quiz, engine, links, results UI, share, trending all done and live-verified. Item swap ("show me another") + per-bundle regenerate shipped 2026-07-20 — see Backlog notes below. |
