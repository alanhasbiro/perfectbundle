...
| **Active Plan** | `docs/superpowers/plans/2026-07-20-signup-event-clerk-webhook.md` (complete, pending owner's live-test confirmation of the now-registered Clerk webhook) |
